-- ============================================================
--  Main.lua — Point d'entrée du framework ESP NexusESP
-- ============================================================
...
do
    ...
    Left:AddToggle("VisibilityCheck", {
        ...
        Tooltip  = "Attenue les joueurs non visibles",
    ...
    Left:AddButton({
        Text = "Mode Preview",
        Func = function() ESP.ShowPreview() end,
    })

    Left:AddButton({
        Text = "Stop Preview",
        Func = function() ESP.RemovePreview() end,
    })
...
do
    ...
    Left:AddToggle("PLShowDist", {
        ...
        Callback = function(val) cfg.PlayerList.ShowDistance = val save() end,
    })

    Left:AddToggle("PLShowHealth", {
        Text     = "Afficher sante",
        Default  = cfg.PlayerList.ShowHealth,
        Callback = function(val) cfg.PlayerList.ShowHealth = val save() end,
    })

    Left:AddToggle("PLShowTeam", {
        Text     = "Afficher equipe",
        Default  = cfg.PlayerList.ShowTeam,
        Callback = function(val) cfg.PlayerList.ShowTeam = val save() end,
    })

    Left:AddToggle("PLShowVisible", {
        Text     = "Afficher visibilite",
        Default  = cfg.PlayerList.ShowVisible,
        Callback = function(val) cfg.PlayerList.ShowVisible = val save() end,
    })
    ...
    Right:AddButton({
        Text = "Unfocus",
        Func = function() PlayerList.Unfocus() end,
    })
end
...
do
    ...
    Left:AddButton({
        ...
        Func = function()
            Config:Save()
            Library:Notify("Configuration sauvegardee !", 3)
        end,
    })
    ...
    Left:AddButton({
        ...
        Func = function()
            Config:Load()
            Library:Notify("Configuration chargee !", 3)
        end,
    })
    ...
    Left:AddButton({
        ...
        Func = function()
            Config:Reset()
            Library:Notify("Config remise a zero", 3)
        end,
    })
...
print("[NexusESP] Framework charge ! (RightCtrl pour toggle UI)")
